...
const LABELS: Style[] = [
  { name: "Label-L", family: "mono", size: "label-l", lineHeight: "label-l", letterSpacing: "label-l", weight: "regular", sample: "LABEL TEXT" },
  { name: "Label-M", family: "mono", size: "label-m", lineHeight: "label-m", letterSpacing: "label-m", weight: "regular", sample: "LABEL TEXT" },
  { name: "Label-S", family: "mono", size: "label-s", lineHeight: "label-s", letterSpacing: "label-s", weight: "regular", sample: "LABEL TEXT" },
  { name: "Label-XS", family: "mono", size: "label-xs", lineHeight: "label-xs", letterSpacing: "label-xs", weight: "regular", sample: "LABEL TEXT" },
];
...
export const All: Story = {
  render: () => (
    <div style={{ maxWidth: 960 }}>
      ...
      <Section title="Labels (Geist Mono)" items={LABELS} />
    </div>
  ),
};
